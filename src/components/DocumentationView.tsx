            ...
            <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 sticky top-8">
              ...
              <div className="pt-6 border-t border-gray-700/50">
                ...
                <div className="space-y-2">
                  ...
                  <a href="https://github.com/yourusername/zk-human/releases" className="flex items-center gap-2 text-sm text-gray-400 hover:text-purple-400 transition-colors">
